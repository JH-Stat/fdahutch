...
The goal of fdahutch is to make regular expressions more exciting! It
provides convenience functions to make some common tasks with string
manipulation and regular expressions a bit easier.

## Installation

You can install the development version of fdahutch from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("JH-Stat/fdahutch")
#> Using GitHub PAT from the git credential store.
#> Downloading GitHub repo JH-Stat/fdahutch@HEAD
#> Error in utils::download.file(url, path, method = method, quiet = quiet,  : 
#>   cannot open URL 'https://api.github.com/repos/JH-Stat/fdahutch/tarball/HEAD'
```
...
That’s exactly what `fdahutch::str_split_one()` does.
