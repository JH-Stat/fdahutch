...
The goal of fdahutch is to make regular expressions more exciting!
...
You can install the development version of fdahutch from [GitHub](https://github.com/) with:
